...
void StV0Maker::initConst() {
  ...
  mMassV0 = 3.926724;    // mass of H4L  //GeV is unit.
  mMass1 = 3.727379378;  // mass of alpha particle    //GeV is unit.
...
void StV0Maker::initParam() {
  ...
  float temp1;
  ifstream f_dedx_th1;
  f_dedx_th1.open("/star/u/jhai/dedx/dedx_mean_He4.dat");
...
Int_t StV0Maker::Make() {
  ...
  if ((fabs(muEvent->primaryVertexPosition().x()) < 1e-5) && (fabs(muEvent->primaryVertexPosition().y()) < 1e-5) &&
  ...
  for (unsigned int i = 0; i < mDauVec1.size(); i++) {
    ...
    for (unsigned int j = 0; j < mDauVec2.size(); j++) {
      ...
      //            if (track1->topologyMap().hasHitInPxlLayer(1))
      //                mPXL1Flag1 = 1;
      //            if (track1->topologyMap().hasHitInPxlLayer(2))
      //                mPXL2Flag1 = 1;
      //            if (track1->topologyMap().hasHitInPxlLayer(3))
      //                mPXL3Flag1 = 1;
      //            if (track1->topologyMap().hasHitInIstLayer(1))
      //                mIST1Flag1 = 1;
      //            if (track1->topologyMap().hasHitInIstLayer(2))
      //                mIST2Flag1 = 1;
      //            if (track1->topologyMap().hasHitInSsdLayer(1))
      //                mSSD1Flag1 = 1;
      //            if (track1->topologyMap().hasHitInSsdLayer(2))
      //                mSSD2Flag1 = 1;
      //            if (track2->topologyMap().hasHitInPxlLayer(1))
      //                mPXL1Flag2 = 1;
      //            if (track2->topologyMap().hasHitInPxlLayer(2))
      //                mPXL2Flag2 = 1;
      //            if (track2->topologyMap().hasHitInPxlLayer(3))
      //                mPXL3Flag2 = 1;
      //            if (track2->topologyMap().hasHitInIstLayer(1))
      //                mIST1Flag2 = 1;
      //            if (track2->topologyMap().hasHitInIstLayer(2))
      //                mIST2Flag2 = 1;
      //            if (track2->topologyMap().hasHitInSsdLayer(1))
      //                mSSD1Flag2 = 1;
      //            if (track2->topologyMap().hasHitInSsdLayer(2))
      //                mSSD2Flag2 = 1;
